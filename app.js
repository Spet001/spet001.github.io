...
// --- DADOS DOS PROJETOS (ATUALIZADOS E INDIVIDUALIZADOS) ---
const relevantProjects = [
    {
        ...
        title: "QA Analyst em 'Sparky Rush'",
        ...
        liveUrlText: "Ver na Steam"
    },
    {
        image: "assets/Outcaster1.jpg",
        title: "Outcaster - Jogo Autoral",
...
const minorProjects = [
    ...
    },
    {
        ...
        title: "GZDoom para UWP/Xbox DevKits",
...
const insignificantProjects = [
    { title: "Scripts e Desafios de Bootcamp", description: "Coleção de projetos desenvolvidos durante bootcamps, desafios de lógica e pequenas aplicações para estudo de tecnologias.", repoUrl: "https://github.com/Spet001?tab=repositories" },
    { title: "Organizador de GDD", description: "Aplicação desktop simples para organizar Game Design Documents (GDDs), desenvolvida para praticar a criação de interfaces com Tkinter.", repoUrl: "https://github.com/Spet001/Organizador-de-GDD" },
    
    { title: "Otimizador WIN10/11", description: "Script com interface gráfica para aplicar otimizações não-invasivas no Windows, visando a melhoria de performance e a limpeza do sistema.", repoUrl: "https://github.com/Spet001/Otimizador-WIN10-11" },
];
